...
{        
    private readonly List<Func<PropertyInfo, object, bool>> _queryStringBuilderFilter = new();
    private readonly Dictionary<Type, Func<PropertyInfo, object, bool>> _accessorFilters = new();
    ...
    public QueryStringConfig()
    {
        ...
        IgnorePropertiesFromType<IPageable>((prop, value) => 
    ...
    public QueryStringConfig IgnoreProperties(Func<PropertyInfo, object, bool> filter)
    {
        _queryStringBuilderFilter.Add(filter);
        return this;
    }

    public QueryStringConfig IgnorePropertiesFromType<TModel>(Func<PropertyInfo, object, bool> filter)
    {
