...
namespace Miru.PageTesting.Tests
{
    ...
    {
        // public class Chrome : ClickLinkSpec
        // {
        //     public Chrome() => _ = DriverFixture.Get.Value.ForChrome();
        // }
    
        public class Firefox : ClickLinkSpec
        {
            public Firefox() => _ = DriverFixture.Get.Value.ForFirefox();
        }
        
        public abstract class ClickLinkSpec
        {
